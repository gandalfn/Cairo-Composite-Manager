...
{
	gchar* string = g_strdup_printf (_("Testing the new settings. If you don't respond in %d second the previous settings will be restored."), self->priv->time);
...
ccm_timed_dialog_new (GtkWidget* parent, guint seconds)
{
	...
	gtk_window_set_position(GTK_WINDOW(self), GTK_WIN_POS_CENTER_ALWAYS);
   	...
   	gtk_label_set_markup (GTK_LABEL (label), _("<b>Do you want to keep these settings?</b>"));
