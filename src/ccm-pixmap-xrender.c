...
ccm_pixmap_xrender_bind (CCMPixmap * pixmap)
{
    ...
    if (!self->priv->surface && visual && ccm_drawable_get_geometry_clipbox (CCM_DRAWABLE (self), &geometry))
    {
        CCMDisplay *display = ccm_drawable_get_display (CCM_DRAWABLE (self));

        self->priv->surface = cairo_xlib_surface_create (CCM_DISPLAY_XDISPLAY (display),
