...
#ifndef _CCM_WINDOW_OPENVG_H_
#define _CCM_WINDOW_OPENVG_H_
...
struct _CCMWindowOpenVGClass
{
    CCMWindowClass parent_class;
};

typedef struct _CCMWindowOpenVGPrivate CCMWindowOpenVGPrivate;

struct _CCMWindowOpenVG
{
