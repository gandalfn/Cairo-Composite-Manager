...
struct _CCMTimelineClass
{
    ...
    void (*new_frame) (CCMTimeline * timeline, gint frame_num);

    void (*marker_reached) (CCMTimeline * timeline, const gchar * marker_name,
                            gint frame_num);
};
...
CCMTimeline *
ccm_timeline_clone (CCMTimeline * timeline);

guint
ccm_timeline_get_duration (CCMTimeline * timeline);
void
ccm_timeline_set_duration (CCMTimeline * timeline, guint msecs);
guint
ccm_timeline_get_speed (CCMTimeline * timeline);
void
ccm_timeline_set_speed (CCMTimeline * timeline, guint fps);
CCMTimelineDirection
ccm_timeline_get_direction (CCMTimeline * timeline);
void
ccm_timeline_set_direction (CCMTimeline * timeline,
                            CCMTimelineDirection direction);
void
ccm_timeline_start (CCMTimeline * timeline);
void
ccm_timeline_pause (CCMTimeline * timeline);
void
ccm_timeline_stop (CCMTimeline * timeline);
void
ccm_timeline_set_loop (CCMTimeline * timeline, gboolean loop);
gboolean
ccm_timeline_get_loop (CCMTimeline * timeline);
void
ccm_timeline_rewind (CCMTimeline * timeline);
void
ccm_timeline_skip (CCMTimeline * timeline, guint n_frames);
void
ccm_timeline_advance (CCMTimeline * timeline, guint frame_num);
gint
ccm_timeline_get_current_frame (CCMTimeline * timeline);
gdouble
ccm_timeline_get_progress (CCMTimeline * timeline);
void
ccm_timeline_set_n_frames (CCMTimeline * timeline, guint n_frames);
guint
ccm_timeline_get_n_frames (CCMTimeline * timeline);
gboolean
ccm_timeline_is_playing (CCMTimeline * timeline);
void
ccm_timeline_set_delay (CCMTimeline * timeline, guint msecs);
guint
ccm_timeline_get_delay (CCMTimeline * timeline);
guint
ccm_timeline_get_delta (CCMTimeline * timeline, guint * msecs);

void
ccm_timeline_add_marker_at_frame (CCMTimeline * timeline,
                                  const gchar * marker_name, guint frame_num);
void
ccm_timeline_add_marker_at_time (CCMTimeline * timeline,
